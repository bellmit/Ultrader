...
class SettingsWizardComp extends Component {
    ...
    constructor(props) {
      ...
      this.steps = [
                                   { name: "Keys", component: <Step1 settings={this.props.settings} onAddSetting={this.props.onAddSetting}/> },
                                   { name: "Finish", component: <FinalStep settings={this.props.settings} saveSettings={this.saveSettings}/> }
                                 ];
  }
